import { RadioGroup,FormControlLabel,Radio, Grid, Select, makeStyles, InputAdornment, TextField, 
    Typography, FormControl, FormGroup,IconButton, OutlinedInput, Button, Checkbox } from '@material-ui/core';
             ...
             <Grid item container spacing={3}>
                ...
                <Grid item direction="column" align="left" xs={12} sm={12} md={4} lg={4}>
                    ...
                    <FormControl component="fieldset">
                        <FormGroup>
                        <FormControlLabel
                            control={<Checkbox checked={cv} color="primary" onChange={handleSubmittedDocuments} name="cv" />}
                            label="Curriculam Vitae"
                        />
                        <FormControlLabel
                            control={<Checkbox checked={educer} color="primary" onChange={handleSubmittedDocuments} name="educer" />}
                            label="Education Certificate"
                        />
                        <FormControlLabel
                            control={<Checkbox checked={excer} color="primary" onChange={handleSubmittedDocuments} name="excer" />}
