    ...
    return (
        <Grid container spacing={3} >
            ...
            <Grid item direction="column" align="left" xs={12} sm={12} md={4} lg={4}>
                ...
                <Grid item direction="column" align="left" xs={12} sm={12} md={4} lg={4}>
                    <Typography variant="h6" color="primary" className={clsx(classes.margin)}>Income Entry</Typography>
                        <TextField
                            required
                            id="incomeEntry"
                            name="incomeEntry"
                ...
                <Grid item direction="column" align="left" xs={12} sm={12} md={4} lg={4}>
                    <Typography variant="h6" color="primary" className={clsx(classes.margin)}>Income Label</Typography>
                        <TextField
                            required
                            id="incomeLabel"
                            name="incomeLabel"
                ...
                <Grid item xs={12} sm={12} md={12} lg={12} align="left">
                        <Button variant="contained" color="primary" className={clsx(classes.roundedButton,classes.whiteColor)}>
                            <Typography variant="h6">Create Income Entry</Typography>
                        </Button>
                </Grid>
