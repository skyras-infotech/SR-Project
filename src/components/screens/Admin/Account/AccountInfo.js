...
import { Grid, makeStyles, Typography, Button, TableContainer, TableCell, Table, TableRow, TableBody } from '@material-ui/core';
            ...
            <Grid container>
                <Grid item xs={12} sm={12} md={12} lg={12} align="right">
                    <Button variant="contained" color="primary" type="submit" className={clsx(classes.roundedButton, classes.whiteColor)}>
                        <Link to="/account/edit-account" style={{ textDecoration: "none",color:"white" }}>Change Profile</Link>
                    </Button>
                </Grid>
            </Grid>
        </Grid>
