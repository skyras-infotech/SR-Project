...
const columns = [
    ...
    { field: 'roomUniqueID', headerName: 'Room Unique ID', width: 150, headerClassName: 'headerStyle'},
    { field: 'hostelName', headerName: 'Hostel Name', width: 150, headerClassName: 'headerStyle'},
    { field: 'roomCategory', headerName: 'Room Category', width: 150, headerClassName: 'headerStyle'},
    { field: 'bedCapacity', headerName: 'Bed Capacity Name', width: 140, headerClassName: 'headerStyle'},
